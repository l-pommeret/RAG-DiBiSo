"""
Script pour tester l'interface web Flask.
"""
...
<head>
    ...
    <title>Assistant Bibliothèques Paris-Saclay - TEST</title>
    <style>
        body {
...
<body>
    <header>
        ...
        <div class="test-mode">
            <strong>Mode test</strong> - Utilise un modèle de langage factice
        </div>
    </header>
...
def initialize_bot():
    """Initialise le bot de test."""
    global bot
    bot = SimpleRagTest(db_dir="vectordb_test")
    print("Bot de test initialisé et prêt à répondre aux questions.")
